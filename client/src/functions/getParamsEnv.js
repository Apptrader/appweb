export default function getParamsEnv() {
    ...
    const VITE_CHAPTERS_PANEL = import.meta.env.VITE_CHAPTERS_PANEL || "/chaptersPanel"
    const VITE_TERMS_AND_CONDITION = import.meta.env.VITE_TERMS_AND_CONDITION || "/termsAndConditions"
    const VITE_USER_PANEL = import.meta.env.VITE_USER_PANEL || "/userControlPanel"
    const VIT_FRONTEND_URL = import.meta.env.VIT_FRONTEND_URL || "http://localhost:5173"
    const  VITE_PAYMENT_SUCCES_SUB = import.meta.env. VITE_PAYMENT_SUCCES_SUB || "/payment/successSub"
    return {
        VIT_FRONTEND_URL, API_URL_BASE, VITE_LOGIN_USER, VITE_HOME, VITE_PAID_PLANS_REGISTER,VITE_PAID_PLAN_LIST,
        VITE_REGISTER_USER, VITE_PROFILE, VITE_PAYMENT_SUCCES, VITE_ALL_VIDEOS,
        VITE_AIQ_BONUS_PLAN, VITE_ABOUT, VITE_CONTACT, VITE_PAYMENT_SUCCES_SUB, VITE_NODE_PROFILE, VITE_ROOT, VITE_REGISTER, VITE_USERS,VITE_PLANS_PANEL, VITE_VIDEOS_PANEL, VITE_CHAPTERS_PANEL, VITE_NEO_TECH_AI_ROBOT, VITE_TERMS_AND_CONDITION, VITE_USER_PANEL
    };
  }
