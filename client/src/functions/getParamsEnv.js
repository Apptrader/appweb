export default function getParamsEnv() {
    ...
    return {
        ...
        VITE_AIQ_BONUS_PLAN, VITE_ABOUT, VITE_CONTACT, VITE_NODE_PROFILE, VITE_ROOT, VITE_REGISTER, VITE_USERS,VITE_PLANS_PANEL, VITE_VIDEOS_PANEL, VITE_CHAPTERS_PANEL, VITE_NEO_TECH_AI_ROBOT
    };
  }
