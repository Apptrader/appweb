...
const {VITE_NEO_TECH_AI_ROBOT} = getParamsEnv()
        ...
        <section className="bg-black pt-24 pb-4 shadow dark:bg-gray-900 m-4">
            <div className="w-full max-w-screen-xl mx-auto md:py-8">
                ...
                <div className="sm:hidden">
                    <Slider {...settings}>
                        <div className="flex justify-center">
                            <a target="_blank" rel="noopener noreferrer" href="https://unionwealthsmanagement.com" className="flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
                        ...
                        <div className="flex justify-center">
                            <a target="_blank" rel="noopener noreferrer"  href="https://tradenitro.com/trading/auth/sign-up?rf=27bec4de655cad95" className="flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
                        ...
                        <div className="flex justify-center">
                            <a target="_blank" rel="noopener noreferrer"  href="https://www.vtmarkets.com/get-trading/forex-trading-account/?affid=900595" className="flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
                        ...
                        <div className="flex justify-center">
                            <a target="_blank" rel="noopener noreferrer" href="https://www.binance.com/en" className="flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
                        ...
                        <div className="flex justify-center">
                            <a target="_blank" rel="noopener noreferrer"  href={VITE_NEO_TECH_AI_ROBOT} className="flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
                ...
                <div className="hidden sm:flex justify-between"> {/* Esta clase mostrará las imágenes estáticamente en dispositivos 'sm' y mayores */}
                    ...
                    <a href={VITE_NEO_TECH_AI_ROBOT} className="flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
