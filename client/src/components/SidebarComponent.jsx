...
const SidebarComponent = () => {
        ...
        return(
            <div className=" bg-gray-800 ">
                ...
                <aside id="logo-sidebar" className="fixed top-11 mt-5  z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
                <div className="h-full px-3 py-4 overflow-y-auto bg-gray-800 dark:bg-gray-800">
                    ...
                    <ul className="space-y-2 font-medium">
                        ...
                        <li>
                            ...
                            <span className="flex-1 ms-3 whitespace-nowrap text-white ">Sign In</span>
                            </a>
                        </li>
                        <li>
                            ...
                            <span className="flex-1 ms-3 whitespace-nowrap text-white ">Sign Up</span>
                            </a>
                        </li>
                    </ul>
                </div>
