        ...
        <div className="font-bold">
            ...
            <section>
                <div className=" mt-32 flex items-center justify-center h-68 bg-black rounded dark:">
                    <img className="w-2/3 h-2/3rounded border-lg" src="https://static.wixstatic.com/media/a1316e_40b7a7d4635a410f926ed8d3ec9c7494~mv2.png/v1/fill/w_1743,h_383,al_c,q_90,usm_0.66_1.00_0.01,enc_auto/a1316e_40b7a7d4635a410f926ed8d3ec9c7494~mv2.png" alt="Descripción de la imagen" />
                </div>
            </section>
        </div>
