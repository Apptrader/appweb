        ...
        <div className="bg-black">
            <div className="p-4 rounded-lg dark:border-gray-700">
                <div className="relative h-4096 mb-4 rounded bg-gray-50 dark:bg-gray-800">
                    ...
                    <div className="mt-10 md:mt-36 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
                        <h1 className="text-4xl md:text-8xl font-bold text-white mb-8">Welcome to AIQ Learning!</h1>
                        <p className="text-2xl md:text-4xl text-gray-400 dark:text-gray-500 mt-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mx-auto max-w-7xl justify-center pt-24 md:pt-64">
                    {/* Package 1 */}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4 py-24 px-4 font-bold rounded dark:bg-gray-800">
                    <div className="bg-black flex flex-col items-center justify-center h-full p-6 rounded dark:">
                            <h1 className="text-4xl md:text-5xl text-white dark:text-gray-500 mb-4 ">
                                About AIQ Learning
                            </h1>
                            <h4 className="text-base md:text-xl text-white">
...
                       <img className="w-48 md:w-[500px] h-48 md:h-[500px] rounded" src="https://media.gettyimages.com/id/1401171512/es/foto/rising-stock-market-trading-chart.jpg?s=2048x2048&w=gi&k=20&c=TrxzuWG_PrPjJHdks1nUy88h91bTu9rNxVnpcUAlKJc=" alt="Descripción de la imagen" />
                    </div>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4 px-4 font-bold rounded dark:bg-gray-800">
                    
                <div ref={ref} className={`items-center justify-center h-68 bg-black rounded dark: ${inView ? 'animate__animated animate__fadeInLeft' : ''}`}>

                            <img className="w-48 md:w-[300px] h-48 md:h-[300px] rounded" src="https://static.wixstatic.com/media/a1316e_a1c7c9e9f742496198740ebb8d23df67~mv2.jpg/v1/fill/w_300,h_300,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/Screen%20Shot%202024-01-03%20at%202_43_edited.jpg" alt="Descripción de la imagen" />
                        </div>
